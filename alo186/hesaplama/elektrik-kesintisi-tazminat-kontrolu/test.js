...
for(const token of ['id="checker"','id="result"','12 saati','30 gün','Hizmet Kalitesi Yönetmeliğinin 26 ncı maddesine göre','FAQPage','WebApplication','/edas-bul','ALO186 EDAŞ, TEDAŞ, EPDK veya kamu kurumu değildir','aria-invalid','hours > 8760','rawHours === \'\' ? Number.NaN']){
