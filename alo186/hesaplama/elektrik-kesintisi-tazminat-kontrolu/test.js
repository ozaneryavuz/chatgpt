...
for(const token of ['id="checker"','id="result"','12 saati','30 gün','FAQPage','WebApplication','/edas-bul','ALO186 EDAŞ, TEDAŞ, EPDK veya kamu kurumu değildir']){
  if(!html.includes(token)) throw new Error(`Eksik sözleşme: ${token}`);
}
for(const forbidden of ['on iş günü','"@type":"Offer"','amazon.com.tr','alo186rehber-21']){
