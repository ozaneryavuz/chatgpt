(function () {
  ...
  function renderResult(result) {
    ...
    if (!result.productRouteAllowed) $('professionalReasons').innerHTML = listMarkup(result.professionalReasons);
  ...
  function calculate(event) {
    ...
    try {
      renderResult(core.calculate(state.loads, optionsFromForm()));
    } catch (error) {
