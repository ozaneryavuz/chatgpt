...
const generator = catalog.getCategory('generator');
assert.ok(generator);
assert.equal(generator.mode, 'guide');
assert.equal(generator.risk, 'safety');
assert.equal(generator.affiliatePolicy, 'after_tool');
assert.match(generator.nextStepUrl, /jenerator-gucu-secimi/);
