(function (root, factory) {
  ...
  function buildResilienceRoutes(summary) {
    ...
    if (medical) {
      routes.push({
        ...
        href: 'https://www.alo186.com/hesaplama/kesinti-hazirlik-plani/',
        commercial: false,
    ...
    if (priorities.internet && (summary.count > 0 || summary.totalMinutes >= 30)) {
      routes.push({
        ...
        href: 'https://www.alo186.com/hesaplama/modem-internet-yedekleme/',
        commercial: false,
    ...
    if ((priorities.lighting || priorities.cold) && (summary.totalMinutes >= 120 || summary.count >= 2)) {
      routes.push({
        ...
        href: 'https://www.alo186.com/hesaplama/ups-suresi/',
        commercial: false,
    ...
    if ((priorities.pump || settings.usage === 'business' || settings.usage === 'hotel' || settings.usage === 'site') && summary.longestMinutes >= 180) {
      routes.push({
        ...
        href: 'https://www.alo186.com/hesaplama/jenerator-gucu-secimi/',
        commercial: false,
    ...
    if (summary.damageEntries.length > 0) {
      routes.push({
        ...
        href: 'https://www.alo186.com/hesaplama/parafudr-risk-testi/',
        commercial: false,
  ...
  function buildEvidenceChecklist(summary) {
    ...
    if (summary.damageEntries.length > 0) {
      ...
      items.push('Cihaz faturası, servis raporu ve olay kayıtlarını birlikte saklayın; EPDK tüketici bilgisinde cihaz hasarı talebi için 10 iş günlük süre açıklanır.');
    }
