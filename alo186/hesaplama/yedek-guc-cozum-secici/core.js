(function(root,factory){
  ...
  const solutions={
    mini_ups:{label:'Modem / ONT Mini UPS',note:'Düşük güçlü DC ağ cihazları için kesintisiz ve sade çözüm.',nextStepUrl:'https://www.alo186.com/hesaplama/modem-internet-yedekleme/',nextStepLabel:'Modem ve ONT hesabını aç',productCategory:'mini_ups'},
    ups:{label:'UPS',note:'Kısa süre ve çok hızlı geçiş isteyen elektronik yükler için.',nextStepUrl:'https://www.alo186.com/hesaplama/ups-suresi/',nextStepLabel:'UPS süre hesabını aç',productCategory:null},
    power_station:{label:'Taşınabilir Power Station',note:'Egzozsuz, taşınabilir ve orta süreli fişli yükler için.',nextStepUrl:'https://www.alo186.com/hesaplama/ups-suresi/',nextStepLabel:'Wh ve çalışma süresi hesabını aç',productCategory:'power_station'},
    inverter_battery:{label:'Saf Sinüs İnverter + Batarya',note:'Batarya altyapısı ve yeniden şarj planı bulunan sistemler için.',nextStepUrl:'https://www.alo186.com/hesaplama/inverter-uygunluk/',nextStepLabel:'İnverter ve batarya testini aç',productCategory:'inverter'},
    generator:{label:'Jeneratör',note:'Uzun süreli veya yüksek enerjili yüklerde, güvenli dış ortam sağlanırsa.',nextStepUrl:'https://www.alo186.com/hesaplama/jenerator-gucu-secimi/',nextStepLabel:'Jeneratör gücü hesabını aç',productCategory:'generator'},
    hybrid:{label:'Hibrit Batarya + Jeneratör / GES',note:'Uzun süre, sessizlik ve sabit tesisatın birlikte istendiği profesyonel mimari.',nextStepUrl:'https://www.alo186.com/haberler/ges-elektrik-kesintisinde-calisir-mi',nextStepLabel:'Hibrit yedekleme rehberini aç',productCategory:null},
    professional:{label:'Profesyonel Yedek Güç Tasarımı',note:'Ürün sınıfından önce tesisat, transfer, faz ve güvenlik tasarımı gerekir.',nextStepUrl:'https://www.alo186.com/hesaplama/jenerator-gucu-secimi/',nextStepLabel:'Ön güç hesabını aç',productCategory:null}
  };
