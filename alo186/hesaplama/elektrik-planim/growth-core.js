...
function seasonalActions(dateValue=new Date()){
 const key=seasonKey(dateValue),map={
  ...
  storm:[
   ...
   {id:'storm-outage',title:'Kesinti günlüğü ve cihaz hasarı kanıtı',detail:'Kesinti zamanını, süreyi ve güvenli gözlemi kaydedin; cihaz hasarında 10 iş günlük resmî süreyi kaçırmayın.',route:'/hesaplama/kesinti-gunlugu/',category:'emergency_light',mode:'free'},
