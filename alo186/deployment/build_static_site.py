...
def normalize_commercial_hub_urls(output: Path) -> dict[str, object]:
    """Ticari hub JSON-LD URL birleştirmelerini canonical path düzeyinde düzeltir.

    Bazı eski üreticiler ``.../amazon-elektrik-urunleri`` kökü ile alt rotayı
    slash eklemeden birleştirebiliyordu. Bu düzeltme yalnız final artifactta
    bozuk absolute URL'yi onarır; ürün, affiliate veya sıralama davranışı eklemez.
    """
