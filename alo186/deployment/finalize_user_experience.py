...
def alias_html(target:str,label:str,b:str)->str:
 u=pub(b,target);css=pub(b,'/alo186-live-quality.css')
 return f'''<!doctype html><html lang="tr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="robots" content="noindex,follow"><meta name="theme-color" content="#071631"><meta name="description" content="Bu eski ALO186 adresi {escape(label,quote=True)} sayfasına güvenli biçimde yönlendirir."><meta http-equiv="refresh" content="0;url={escape(u,quote=True)}"><link rel="canonical" href="{ORIGIN}{target}"><link rel="stylesheet" href="{css}" data-alo186-live-quality="true"><title>{escape(label)} sayfasına taşındı | ALO186</title><meta {MARK} content="legacy-alias-v1"></head><body><main style="max-width:46rem;margin:4rem auto;padding:1.2rem;font:17px/1.6 system-ui,sans-serif;color:#10243a"><h1>İçerik yeni adresine taşındı</h1><p>Aradığınız bilgi güncel ALO186 yapısında <strong>{escape(label)}</strong> altında bulunuyor.</p><p><a href="{u}">Güncel sayfayı aç →</a></p><p>ALO186 bağımsız bilgi platformudur; resmî başvuru veya arıza kaydı almaz.</p></main><script>location.replace({json.dumps(u,ensure_ascii=False)}+location.search+location.hash);</script></body></html>'''
