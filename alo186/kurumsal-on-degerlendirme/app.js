(() => {
  ...
  const serviceProfiles = {
    ...
    site_villa_audit:{label:'Site ve Villa Elektrik Güvenliği ile EV Altyapı Denetimi',facility:'site',problem:'ev',backup:'both',scope:'site',urgency:'soon',evidence:'partial'}
  };
