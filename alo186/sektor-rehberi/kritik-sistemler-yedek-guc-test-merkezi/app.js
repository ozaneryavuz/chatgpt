(() => {
  ...
  const SYSTEMS={
    ...
    internet:{title:'Modem ve ONT',route:'/hesaplama/modem-ont-mini-ups-uygunluk/',first:'Modem ve ONT adaptör değerlerini ayrı doğrulayın.',checks:['Modem ve ONT voltaj/polarite','Toplam W','DC kablo uyumu','Operatör altyapısı bağımlılığı']},
