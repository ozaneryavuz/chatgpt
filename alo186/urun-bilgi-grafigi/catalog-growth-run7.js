(function(root,factory){
  const current=root&&root.Alo186ProductCatalog
    ...
    : (typeof module==='object'&&module.exports ? require('../urun-eslestirme/catalog-growth-run7.js') : null);
  ...
  'use strict';
  if(!catalog)throw new Error('ALO186 run7 Product Knowledge Graph yüklenemedi.');
  return catalog;
});
