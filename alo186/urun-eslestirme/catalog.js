(function(root,factory){
  ...
  const categories=[
    ...
    {id:'surge_strip',name:'Akım korumalı grup priz',mode:'guide',risk:'consumer',affiliatePolicy:'after_tool',nextStepUrl:'https://www.alo186.com/hesaplama/akim-korumali-priz-uygunluk/',nextStepLabel:'Önce yük, joule, priz ve topraklama uygunluğunu test et',description:'Toplam watt, akım, kalkış, joule, koruma göstergesi, priz sayısı, kablo uzunluğu ve işlevsel topraklama doğrulanmadan ürün kartı açılmamalıdır. Pano tipi SPD ve tesisat korumasının yerine geçmez.',searchQuery:'akım korumalı grup priz joule'},
