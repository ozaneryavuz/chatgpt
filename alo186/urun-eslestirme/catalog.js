(function(root,factory){
  ...
  const categories=[
    ...
    {id:'generator',name:'Taşınabilir jeneratör',mode:'guide',risk:'safety',affiliatePolicy:'after_tool',nextStepUrl:'https://www.alo186.com/hesaplama/jenerator-gucu-secimi/',nextStepLabel:'Önce jeneratör güç hesabını yap',description:'Sürekli ve kalkış W, faz, çıkış kalitesi, CO güvenliği, gürültü, yakıt ve servis koşulları güç hesabıyla birlikte doğrulanmalıdır.',searchQuery:'inverter jeneratör CO sensörü sürekli kalkış watt'},
