(function (root, factory) {
  ...
  const products = Object.freeze([
    Object.freeze({
      ...
      mpn: 'UH9120C',
      brand: 'TP-Link',
      name: 'TP-Link UH9120C 9-Port USB Type-C Hub',
      verifiedAt,
      amazonSource: 'https://www.amazon.com.tr/dp/B0DJH27B1Q',
      technicalSource: 'https://www.tp-link.com/tr/home-networking/computer-accessory/uh9120c/',
      userNeed: 'Tek bir tam işlevli USB-C portundan 4K 60 Hz sınıfı HDMI, Gigabit Ethernet, SD/microSD, bir USB-C ve üç USB-A veri portu almak.',
      strengths: Object.freeze([
        'Üretici kaynağında 9 bağlantı: HDMI, Gigabit Ethernet, SD, microSD, USB-C PD, bir USB-C ve üç USB-A veri portu',
        'Uygun ana cihazda HDMI üzerinden 4K 60 Hz görüntü sınıfı',
        'USB-C ve USB-A veri portlarında 5 Gbps, kart yuvalarında 104 MB/s sınıfı',
        'Amazon Türkiye ürün kaydı ASIN B0DJH27B1Q ile UH9120C modelini eşler',
      ]),
      limitations: Object.freeze([
        '4K 60 Hz için ana cihazın USB-C görüntü aktarımını ve uygun görüntü standardını desteklemesi gerekir',
        '100 W ifadesi PD giriş sınıfıdır; üretici açıklamasına göre hub arayüzleri için güç ayrılır ve ana cihaza ulaşan gerçek güç daha düşük olabilir',
        'Kart okuyucular, ağ, görüntü ve USB çevre birimleri aynı ana bağlantının bant genişliği ile güç bütçesini paylaşır',
      ]),
      noBuyWhen: 'Yalnız bir veya iki dönüştürücüye ihtiyacınız varsa, cihaz USB-C görüntü çıkışı sunmuyorsa, mevcut hub port ihtiyacını karşılıyorsa veya görev kritik bir profesyonel sistemse satın almayın.',
    }),
    Object.freeze({
      id: 'tp-link-uh6120c',
      asin: 'B0DCZY52K3',
