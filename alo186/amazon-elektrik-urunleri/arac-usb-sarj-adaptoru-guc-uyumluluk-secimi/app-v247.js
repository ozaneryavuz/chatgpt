(function () {
  "use strict";
  const catalog = window.ALO186VehicleUSBChargerCatalogV247;
  if (!catalog) return;
  ...
  function update() {
    if (!readinessIds.every(checked)) {
      return lock("Önce araç prizi, gerilim, fiziksel durum, cihaz protokolü, kablo, güç, yüksek risk, mevcut çözüm ve varyant kontrollerini tamamlayın.");
    }
    ...
    status.textContent = opened
      ? "Kontroller tamamlandı. Amazon Türkiye sayfasında ASIN, MPN, port, protokol ve güç profilini yeniden doğrulayın."
