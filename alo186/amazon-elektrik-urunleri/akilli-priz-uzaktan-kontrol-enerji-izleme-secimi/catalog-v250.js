(function (root, factory) {
  ...
  else root.ALO186SmartPlugCatalogV250 = catalog;
  ...
  const catalog = {
    ...
    category: {
      ...
      slug: "akilli-priz-uzaktan-kontrol-enerji-izleme-secimi",
      risk: "consumer-medium",
      affiliatePolicy: "after_tool",
      requiredTool: "embedded-smart-plug-readiness-v250",
      professionalOnly: false,
      highRiskDirectCta: false,
      excludes: [
        "topraksız, gevşek, kararmış, ısınan, fiziksel olarak hasarlı veya nemli prizde kullanım",
        "elektrikli araç şarjı, sabit tesisat, pano, UPS, jeneratör, medikal cihaz veya yaşam güvenliği yükü",
        "ısıtıcı, ütü, su ısıtıcı, klima, pompa, kompresör, buzdolabı veya yüksek ilk kalkış akımlı yük",
        "gözetimsiz kritik yük, yangın alarmı, güvenlik sistemi veya erişim kontrolü",
        "ürünün anma akımı, güç, sıcaklık ve iç ortam sınırlarını aşan kullanım",
        "çoklu prizleri zincirleme, adaptör üstüne adaptör takma veya kalıcı tesisat oluşturma"
      ]
    },
    products: [
      {
        ...
        verifiedAt: "2026-08-03",
        userNeed: "Tek bir düşük veya orta güçlü fişli cihazı uzaktan açıp kapatmak ve gerçek zamanlı/tarihsel tüketimini izlemek isteyen, 2,4 GHz Wi-Fi ve Matter uyumunu doğrulayabilen kullanıcı.",
        strengths: [
          "Üretici beyanıyla gerçek zamanlı ve tarihsel enerji izleme",
          "Matter, Meross, Apple Home, Alexa ve Google ekosistemleriyle birlikte çalışabilme",
          "16 A maksimum çıkış ve yerel çoklu yönetici desteği"
        ],
        limitations: [
          "16 A etiketi duvar prizi, tesisat ve bağlı cihazın otomatik olarak uygun olduğu anlamına gelmez",
          "Matter kurulumu için seçilen platforma göre uyumlu merkez, güncel telefon ve ağ gerekebilir",
      ...
      },
      {
        ...
        strengths: [
          "Üretici dokümanında voltmetre, ampermetre, güç ve enerji ölçümü",
      ...
      },
      {
        ...
        limitations: [
          ...
          "10 A ve 2300 W ürün sınırı bağlı yükün etiketi ve priz güvenliğiyle birlikte doğrulanmalıdır",
        ...
        technical: {
          ...
          functions: "Uzaktan kontrol, program, zamanlayıcı, sesli kontrol"
        },
