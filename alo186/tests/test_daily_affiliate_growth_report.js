...
assert.ok(report.summary.totalVerifiedProducts >= 10);
...
console.log(JSON.stringify({ ok: true, topActions: report.topActions.map((action) => action.categoryId), summary: report.summary }, null, 2));
