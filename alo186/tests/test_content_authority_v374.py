...
ALO = ROOT / "alo186"
ROUTING = ALO / "deployment/routing-overlays/content-authority-v374-ev-bess-overspeed.json"

ARTICLES = {
    "ev-sarj-input-voltage-too-low-dusuk-gerilim-hatasi": {
        "canonical": "https://alo186.com/haberler/ev-sarj-input-voltage-too-low-dusuk-gerilim-hatasi",
        "sources": ("tesla.com", "webstore.iec.ch"),
        "needles": ("Input Voltage Too Low", "gerilim düşümü", "pano", "EVSE"),
    },
    "bess-precharge-hatasi-kontaktor-dc-link-welded": {
        "canonical": "https://alo186.com/haberler/bess-precharge-hatasi-kontaktor-dc-link-welded",
        "sources": ("ti.com", "nxp.com", "webstore.iec.ch"),
        "needles": ("Precharge Failed", "DC-link", "Welded Contactor", "inrush"),
    },
    "jenerator-overspeed-asiri-devir-alarmi-rpm": {
        "canonical": "https://alo186.com/haberler/jenerator-overspeed-asiri-devir-alarmi-rpm",
        "sources": ("documentation.deif.com", "iso.org"),
        "needles": ("Overspeed", "ANSI 12", "MPU", "over-frequency"),
    },
}
...
class ContentAuthorityV374Tests(unittest.TestCase):
    ...
    def test_routing_overlay_is_exact_and_no_buy_first(self) -> None:
        ...
        self.assertEqual(374, data["version"])
