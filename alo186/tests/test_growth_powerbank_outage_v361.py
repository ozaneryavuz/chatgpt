...
ROUTING = ROOT / "deployment/routing-overlays/growth-powerbank-outage-v361.json"
...
def test_routing_overlay_v361_owns_three_new_routes():
    text = read(ROUTING)
    assert '"version": 361' in text
    for route in (
...
if __name__ == "__main__":
    ...
    test_routing_overlay_v361_owns_three_new_routes()
    print({"ok": True, "version": 361, "merchantLinks": 0, "newAffiliateClasses": 0})
