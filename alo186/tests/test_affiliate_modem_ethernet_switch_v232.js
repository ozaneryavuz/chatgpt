...
const ROUTE=path.join(ROOT,'amazon-elektrik-urunleri','modem-ethernet-switch-port-hiz-olcum-secimi');
...
const EXPECTED=new Map([['B07RK6CVS3','LS1005G'],['B00K4DS5KU','TL-SG108E'],['B08WQ16H4N','TL-SG108-M2']]);
...
assert.strictEqual(catalog.category.requiredTool,'embedded-modem-ethernet-switch-measurement-v232');
...
const canonical='https://alo186.com/amazon-elektrik-urunleri/modem-ethernet-switch-port-hiz-olcum-secimi/';
