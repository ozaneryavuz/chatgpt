...
ARTICLES = [
    {
        "slug": "elektrik-kesilmeden-cihazlar-resetleniyor-gerilim-cukuru-kisa-kesinti",
        "required": [
            "voltage sag",
            "short interruption",
            "IEC 61000-4-30",
        ...
        "source_hosts": ["se.com", "productinfo.schneider-electric.com", "fluke.com"],
    },
    {
        "slug": "ges-anti-islanding-loss-of-mains-yeniden-baglanma-testi",
        "required": [
        ...
        "links": [
            ...
            "/haberler/ges-zero-export-ct-yonu-faz-eslesmesi",
    ...
    {
        "slug": "ups-aku-odasi-havalandirma-hidrojen-gaz-algilama",
        "required": [
            "stationary battery",
        ...
        "links": [
            "/haberler/ups-aku-sicaklik-kompanzasyonu-termal-kacak",
            "/hesaplama/elektrik-kanit-envanteri/",
            "/hesaplama/teknik-devir-kabul-paketi/",
            "/hizmetler/elektrik-surekliligi-izleme/",
        ],
        "source_hosts": ["webstore.iec.ch", "osha.gov", "eaton.com", "enersys.com"],
    },
]
...
def main() -> None:
    ...
    assert manifest["version"] >= 47, manifest["version"]
    article_routes = [route for route in manifest["routes"] if route["type"] == "article"]
    assert len(article_routes) >= 108, len(article_routes)
