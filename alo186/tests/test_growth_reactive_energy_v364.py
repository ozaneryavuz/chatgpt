...
ROUTING = ROOT / "deployment/routing-overlays/growth-reactive-energy-v364.json"
...
def test_routing_overlay_v364_owns_three_routes():
    text = read(ROUTING)
    assert '"version": 364' in text
    for route in (
...
if __name__ == "__main__":
    ...
    test_routing_overlay_v364_owns_three_routes()
    print({"ok": True, "version": 364, "merchantLinks": 0, "newAffiliateClasses": 0})
