...
OVERLAY = ROOT / "alo186/deployment/routing-overlays/content-authority-run73.json"
PAGES = {
    "/haberler/harmonik-notr-akimi-triplen-k-faktor-trafo-secimi": {
        "path": ROOT / "alo186/haberler/harmonik-notr-akimi-triplen-k-faktor-trafo-secimi/index.html",
        "intent": ("triplen harmonik", "nötr akımı", "K-faktörlü trafo", "H3", "termal kontrol"),
        "sources": ("iec.ch", "se.com", "eaton.com"),
        "separation": ("triplen harmoniklerin nötr akımı", "harmonik çözüm rehberini"),
        "boundary": "Satın almama sınırı",
    },
    "/haberler/parafudr-gosterge-kirmizi-yesil-uzak-kontak-degisim": {
        "path": ROOT / "alo186/haberler/parafudr-gosterge-kirmizi-yesil-uzak-kontak-degisim/index.html",
        "intent": ("durum göstergesi", "kartuş", "uzak kontak", "kırmızı", "BMS"),
        "sources": ("iec.ch", "se.com", "phoenixcontact.com"),
        "separation": ("durum göstergesi, kartuş değişimi", "SPD koordinasyon rehberini"),
        "boundary": "Satın almama sınırı",
    },
    "/haberler/kurulu-baglanti-sozlesme-talep-gucu-guc-artisi": {
        "path": ROOT / "alo186/haberler/kurulu-baglanti-sozlesme-talep-gucu-guc-artisi/index.html",
        "intent": ("kurulu güç", "bağlantı gücü", "sözleşme gücü", "talep gücü", "güç artışı"),
        "sources": ("epdk.gov.tr",),
        "separation": ("EDAŞ güç artışı sürecini", "fatura itiraz rehberini"),
