...
def main() -> None:
    with tempfile.TemporaryDirectory() as temporary:
        ...
        assert "Cihaz hasarında talep süresi 10 iş günüdür" in home
        assert "zararın ortaya çıktığı tarihten itibaren <strong>10 iş günü içinde</strong>" in home
        assert "Cihaz hasarında başvuru süresi 30 gündür" not in home
        assert "zararın ortaya çıktığı tarihten itibaren <strong>30 gün içinde</strong>" not in home
        ...
        assert "10 iş günü" in home_md
        assert "başvuru süresi 30 gündür" not in home_md
        ...
        assert deadline["value"] == "10 iş günü"
        assert deadline["sourcePublisher"].startswith("Enerji Piyasası Düzenleme Kurumu")
        assert deadline["sourceUrl"].startswith("https://www.epdk.gov.tr/")
        ...
        assert "resmî tatilleri otomatik hesaplamaz" in journal
        ...
        for token in ("addBusinessDays", "BEGIN:VCALENDAR", "10 iş günlük süre", "localStorage"):
