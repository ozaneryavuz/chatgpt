...
OVERLAY = ROOT / "alo186/deployment/routing-overlays/180-access-continuity-growth.json"
...
def main() -> None:
    ...
    for name in ("accessible", "lock"):
        ...
        assert "Fiyat, stok, puan" in html or "fiyat, stok, puan" in html
    ...
    audit = read(ROOT / "alo186/audits/access-continuity-growth-v180-2026-08-01.md")
    ...
    print("access continuity growth v180 contract: OK")
