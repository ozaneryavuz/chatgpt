...
SITE = ROOT / "alo186"
OVERLAY = SITE / "deployment/routing-overlays/smart-home-intercom-outage-journey-v319.json"

ROUTES = {
    "/haberler/elektrik-kesilince-akilli-ev-diafon-calisir-mi/": SITE / "haberler/elektrik-kesilince-akilli-ev-diafon-calisir-mi/index.html",
    "/hesaplama/akilli-ev-diafon-elektrik-kesintisi-hazirlik-plani/": SITE / "hesaplama/akilli-ev-diafon-elektrik-kesintisi-hazirlik-plani/index.html",
    "/sektor-rehberi/apartman-otel-akilli-ev-diafon-kesinti-surekliligi/": SITE / "sektor-rehberi/apartman-otel-akilli-ev-diafon-kesinti-surekliligi/index.html",
}
...
def main() -> None:
    ...
    guide = pages["/haberler/elektrik-kesilince-akilli-ev-diafon-calisir-mi/"]
    ...
    planner = pages["/hesaplama/akilli-ev-diafon-elektrik-kesintisi-hazirlik-plani/"]
    ...
    for required in (
        ...
        "BEGIN:VCALENDAR",
        "30/90/365",
        "Aktif güvenlik olayında form ve ticaret kapalı",
        "Professional-only kabul ve düzeltici faaliyet gerekir",
        "Mevcut kesinti hazırlığı yeterli — yeni ürün almayın",
    ...
    sector = pages["/sektor-rehberi/apartman-otel-akilli-ev-diafon-kesinti-surekliligi/"]
    ...
    for required in (
        ...
        "Gerçek elektrik ve internet kesintisi görev/kabul testi",
    ...
    print(json.dumps({
        ...
        "activeSecurityCommerceClosed": True,
