...
OVERLAY = ROOT / "alo186/deployment/routing-overlays/content-authority-run74.json"
PAGES = {
    "/haberler/havuz-elektrik-guvenligi-espotansiyel-rcd-selv-bolgeler": {
        "path": ROOT / "alo186/haberler/havuz-elektrik-guvenligi-espotansiyel-rcd-selv-bolgeler/index.html",
        "intent": ("havuz elektrik güvenliği", "SELV", "eşpotansiyel kuşaklama", "havuz bölgeleri", "RCD açma süresi"),
        "sources": ("iec.ch", "electrical.theiet.org", "electrical-installation.org"),
        "separation": ("havuz bölgeleri, SELV", "RCD ramp ve açma süresi rehberini"),
        "boundary": "Satın almama sınırı",
    },
    "/haberler/inverter-ada-modu-notr-toprak-rolesi-rcd-eps": {
        "path": ROOT / "alo186/haberler/inverter-ada-modu-notr-toprak-rolesi-rcd-eps/index.html",
        "intent": ("ada modu", "EPS çıkışı", "nötr–toprak bağı", "toprak rölesi", "ortak nötr"),
        "sources": ("iec.ch", "victronenergy.com", "sma.de"),
        "separation": ("ada modunda nötr–toprak ve RCD zincirini", "Jeneratör nötrü ve 3/4 kutuplu ATS rehberi"),
        "boundary": "Satın almama sınırı",
    },
    "/haberler/toprak-ozdirenci-wenner-dort-kazik-mevsimsel-olcum": {
        "path": ROOT / "alo186/haberler/toprak-ozdirenci-wenner-dort-kazik-mevsimsel-olcum/index.html",
        "intent": ("toprak özdirenci", "Wenner yöntemi", "dört kazık", "mevsimsel değişim", "IEEE 81"),
        "sources": ("standards.ieee.org", "fluke.com", "iec.ch"),
        "separation": ("toprak özdirenci tasarım girdisini", "topraklama direnci ölçüm rehberini"),
        "boundary": "Yeni elektrot yapmama sınırı",
    },
}
