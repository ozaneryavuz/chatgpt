...
// Kritik tüketici hakkı ve bağımsızlık sözleşmesi.
...
// Kaynak klasör adlarının production URL gibi kullanılmasını engelle.
const staleRoutes = [
  'href="./turkiye-arama/"',
  'href="./karar-motoru/"',
...
// Erişilebilirlik, mobil hedef ve metin kırpma korumaları.
for (const token of [
  '.skip-link',
  'a:focus-visible',
  'min-height:44px',
...
// Production host, güvenlik başlıkları ve eski canlı hukuki metne fail-safe.
