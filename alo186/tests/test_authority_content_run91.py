...
OVERLAY = ROOT / "alo186/deployment/routing-overlays/content-authority-run91.json"
PAGES = {
    "/haberler/ev-sarj-open-pen-kopmasi-opdd-koruma-kabul": {
        "path": ROOT / "alo186/haberler/ev-sarj-open-pen-kopmasi-opdd-koruma-kabul/index.html",
        "intent": ("Open PEN", "PEN iletkeni", "OPDD", "dokunma gerilimi", "şebeke topolojisi"),
        "sources": ("iec.ch", "theiet.org"),
        "separation": ("dağıtım tarafındaki açık PEN arızası", "CP/PP ve kilit rehberi", "V2G rehberi"),
        "boundary": "Şebeke topolojisi ve ürünün open PEN yöntemi doğrulanmadan wallbox veya OPDD satın almayın",
        "cta": "/hizmetler/elektrik-surekliligi/",
    },
    "/haberler/jenerator-reverse-power-ters-guc-ansi-32r-motoring-koruma": {
        "path": ROOT / "alo186/haberler/jenerator-reverse-power-ters-guc-ansi-32r-motoring-koruma/index.html",
        "intent": ("reverse power", "ANSI 32R", "motoring", "prime mover", "CT polaritesi"),
        "sources": ("deif.com", "abb", "se.com"),
        "separation": ("aktif gücün ters yönde akması", "ATS zamanlama rehberi", "UPS-jeneratör rehberi"),
        "boundary": "CT yönü ve gerçek kW trendi doğrulanmadan 32R rölesi veya daha büyük motor satın almayın",
        "cta": "/hizmetler/elektrik-surekliligi/",
    },
    "/haberler/vpp-toplayici-sozlesmesi-soc-telemetri-gelir-ceza-kontrol-listesi": {
        "path": ROOT / "alo186/haberler/vpp-toplayici-sozlesmesi-soc-telemetri-gelir-ceza-kontrol-listesi/index.html",
        "intent": ("VPP", "toplayıcı", "minimum SoC", "telemetri", "temel tüketim"),
        "sources": ("epdk.gov.tr", "teias.gov.tr", "epias.com.tr"),
        "separation": ("teknik kontrol yetkisi", "V2G rehberi", "BESS kapasite rehberi"),
        "boundary": "Net gelir, minimum SoC ve çıkış hakkı yazılmadan VPP aboneliği veya ek batarya satın almayın",
        "cta": "/hizmetler/elektrik-surekliligi/",
    },
}
