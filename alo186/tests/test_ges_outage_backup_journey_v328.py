...
SITE = ROOT / "alo186"
OVERLAY = SITE / "deployment/routing-overlays/ges-outage-backup-journey-v328.json"
GUIDE = SITE / "haberler/elektrik-kesilince-gunes-panelleri-calisir-mi/index.html"
PLANNER = SITE / "hesaplama/ges-elektrik-kesintisi-yedekleme-hazirlik-plani/index.html"
SECTOR = SITE / "sektor-rehberi/otel-isletme-ges-elektrik-kesintisi-yedekleme-surekliligi/index.html"
ROUTES = {
    "/haberler/elektrik-kesilince-gunes-panelleri-calisir-mi/": GUIDE,
    "/hesaplama/ges-elektrik-kesintisi-yedekleme-hazirlik-plani/": PLANNER,
    "/sektor-rehberi/otel-isletme-ges-elektrik-kesintisi-yedekleme-surekliligi/": SECTOR,
}
...
def main() -> None:
    ...
    for required in (
        "anti-islanding",
        "TEDAŞ",
        "Kesintide GES'i doğaçlama ada sistemine çevirmeyin",
    ...
    print(json.dumps({
        ...
        "antiIslandingBypassForbidden": True,
        "noBuyOutcome": True,
