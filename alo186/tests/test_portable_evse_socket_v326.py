...
def main() -> None:
    ...
    assert "amazon.com" not in html.casefold(), "Mağaza bağlantısı ilk HTML yükünde görünmemeli."
    ...
    for token in [
        ...
        "AFFILIATE_TAG='alo186rehber-21'", "https://www.amazon.com.tr/s?k=",
        "sponsored nofollow noopener", "amazonSearchUrl", "searchQueryForResult",
    ...
    print(json.dumps({
        ...
        "conditionalAffiliateSearchLinks": 1,
        "initialStoreLinks": 0,
        "personalDataFields": 0,
        "browserStorage": False,
        "affiliateTripleGate": True,
        "affiliateRelSponsored": True,
