...
OVERLAY = ROOT / "alo186/deployment/routing-overlays/content-authority-run77.json"
PAGES = {
    "/haberler/ups-aku-odasi-havalandirma-hidrojen-vrla-guvenligi": {
        "path": ROOT / "alo186/haberler/ups-aku-odasi-havalandirma-hidrojen-vrla-guvenligi/index.html",
        "intent": ("VRLA", "Hidrojen", "fan arızasını", "Sıcaklık haritası", "Gerçek hava akışını"),
        "sources": ("iec.ch", "osha.gov", "eaton.com"),
        "separation": ("akü odasındaki gaz, havalandırma, sıcaklık ve bakım kabulünü", "UPS akü kapasite ve empedans testi", "VRLA–lityum retrofit rehberi"),
        "boundary": "Satın almama sınırı",
        "cta": "/hizmetler/elektrik-surekliligi/",
    },
    "/haberler/vpp-toplayici-sozlesmesi-baseline-telemetri-gelir-paylasimi": {
        "path": ROOT / "alo186/haberler/vpp-toplayici-sozlesmesi-baseline-telemetri-gelir-paylasimi/index.html",
        "intent": ("Temel tüketim değeri", "Telemetri", "Aktivasyon", "Uzlaştırma", "Gelir paylaşımı"),
        "sources": ("epdk.gov.tr",),
        "separation": ("VPP/toplayıcı sözleşmesindeki baseline, telemetri, performans ve gelir paylaşımı kabulünü", "BESS garanti ve throughput rehberi", "EV dinamik yük yönetimi"),
        "boundary": "Yatırım yapmama sınırı",
        "cta": "/hizmetler/ges-batarya-ev-sarj-fizibilitesi/",
    },
    "/haberler/ges-panel-pid-lid-letid-guc-kaybi-teshisi": {
        "path": ROOT / "alo186/haberler/ges-panel-pid-lid-letid-guc-kaybi-teshisi/index.html",
        "intent": ("PID-shunting", "PID-polarization", "LID", "LeTID", "IV eğrisi"),
        "sources": ("iec.ch", "nrel.gov"),
        "separation": ("modül teknolojisine bağlı PID, LID ve LeTID güç kaybı teşhisini", "MC4 ve krimp rehberi", "panel hotspot rehberi"),
        "boundary": "Satın almama sınırı",
        "cta": "/hizmetler/ges-batarya-ev-sarj-fizibilitesi/",
    },
}
