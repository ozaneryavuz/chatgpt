...
OVERLAY = ROOT / "alo186/deployment/routing-overlays/content-authority-run72.json"
PAGES = {
    "/haberler/ges-sifir-ihracat-zero-export-anti-islanding-kabul-testi": {
        "path": ROOT / "alo186/haberler/ges-sifir-ihracat-zero-export-anti-islanding-kabul-testi/index.html",
        "intent": ("sıfır ihracat", "anti-islanding", "CT yönü", "fail-safe", "yük düşüş testi"),
        "sources": ("iec.ch", "sma.de", "huawei.com"),
        "separation": ("sıfır ihracat kontrolü", "kesintide GES çalışma rehberini"),
    },
    "/haberler/kompanzasyon-kondansatoru-sisme-patlama-harmonik-rezonans-detuned-reaktor": {
        "path": ROOT / "alo186/haberler/kompanzasyon-kondansatoru-sisme-patlama-harmonik-rezonans-detuned-reaktor/index.html",
        "intent": ("kondansatör", "harmonik rezonans", "detuned reaktör", "ayar frekansı", "kademe testi"),
        "sources": ("iec.ch", "se.com"),
        "separation": ("kompanzasyon kondansatörü arızası", "aktif/pasif filtre teknoloji seçimi"),
    },
    "/haberler/ups-kva-kw-guc-faktoru-crest-factor-nonlinear-yuk-secimi": {
        "path": ROOT / "alo186/haberler/ups-kva-kw-guc-faktoru-crest-factor-nonlinear-yuk-secimi/index.html",
        "intent": ("UPS kVA", "UPS kW", "güç faktörü", "crest factor", "doğrusal olmayan yük"),
        "sources": ("iec.ch", "se.com"),
        "separation": ("UPS kVA, kW, güç faktörü", "batarya kapasitesi"),
    },
}
