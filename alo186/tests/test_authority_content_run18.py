...
ARTICLES = [
    {
        "slug": "jenerator-ats-3-kutuplu-4-kutuplu-notr-anahtarlama",
        "required": [
            "switched neutral",
            "solid neutral",
            "overlapping neutral",
        ...
        "links": [
            ...
            "/haberler/jenerator-devreye-girince-kacak-akim-rolesi-neden-atar",
        ...
        "source_hosts": ["se.com", "eaton.com"],
    },
    {
        "slug": "topraklama-direnci-pensle-olculur-mu-kazikli-test-farki",
        "required": [
            "stakeless",
            "fall-of-potential",
            "selective grounding test",
            "paralel",
            "tek izole elektrot",
            "IEEE 81-2025",
            "Son doğrulama: 29 Temmuz 2026",
        ...
        "links": [
            ...
            "/haberler/topraklama-direnci-ariza-cevrim-empedansi-farki",
            "/haberler/prizde-topraklama-var-mi-priz-test-cihazi",
            "/hesaplama/teknik-devir-kabul-paketi/",
        ],
        "source_hosts": ["ieee.org", "fluke.com", "megger.com"],
    },
    {
        "slug": "batarya-precharge-on-sarj-kontaktor-kaynamasi",
        "required": [
            "battery precharge",
            "DC bus",
            "precharge resistor",
            "contactor weld",
            "precharge timeout",
            "yüzlerce veya binlerce amper",
            "Son doğrulama: 29 Temmuz 2026",
        ],
        "links": [
            "/haberler/batarya-soc-soh-farki-kapasite-saglik-nasil-anlasilir",
            "/haberler/batarya-c-rate-dod-kullanilabilir-kapasite",
            "/haberler/inverter-dusuk-voltaj-alarmi-neden-verir",
            "/hesaplama/inverter-uygunluk/",
            "/hesaplama/teknik-devir-kabul-paketi/",
        ],
        "source_hosts": ["prohelion.com", "sensata.com", "te.com", "tesla.com"],
    },
]
...
def main() -> None:
    ...
    assert manifest["version"] >= 43, manifest["version"]
    article_routes = [route for route in manifest["routes"] if route["type"] == "article"]
    assert len(article_routes) >= 96, len(article_routes)
