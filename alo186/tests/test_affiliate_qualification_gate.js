...
const owned=suitability.evaluate({ownership:'owned',loadType:'router',continuousW:90,peakW:140,hoursDaily:24,requiredOutlets:4,productOutlets:5,ratedCurrentA:10,ratedPowerW:2300,joules:900,usbNeeded:true,usbPorts:2,groundStatus:'verified',labelVerified:true,overloadProtection:true,protectionIndicator:true,damageFree:true,dryIndoor:true,directWall:true,uncovered:true});
...
console.log(JSON.stringify({ok:true,qualifiedMatches:withGate.matches.length,noBuy:owned.noPurchase,unsafeBlocked:heater.status},null,2));
