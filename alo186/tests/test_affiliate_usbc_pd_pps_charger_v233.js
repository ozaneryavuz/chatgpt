...
const EXPECTED=new Map([['B0DFX1N74Z','ACH08448'],['B0B4DL9XSV','ACH03714'],['B0B4K26Z58','ACH03717']]);
...
const visibleTrust=HTML.toLocaleLowerCase('tr-TR');
assert.ok(visibleTrust.includes('mevcut') && visibleTrust.includes('satın alma'));
