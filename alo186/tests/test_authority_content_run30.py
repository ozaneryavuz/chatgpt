...
ARTICLES = [
    {
        "slug": "elektrik-kesintisi-tazminati-yillik-uzun-sureli-nasil-odenir",
        "required": [
            "başvuru gerekmeksizin", "12 saati aşan", "takip eden yılın Nisan",
            "15 iş günü", "cihaz hasarı", "Ticari sınır",
        ...
        "links": [
            ...
            "/elektrik-kesintisi", "/edas-bul", "/hesaplama/kesinti-gunlugu/",
            "/hesaplama/gerilim-olayi-edas-olcum-talebi/",
        ],
        "source_hosts": ["epdk.gov.tr"],
    },
    {
        "slug": "ups-aku-ic-direnc-impedans-kapasite-testi-farki",
        "required": [
            "kapasite deşarj", "tek bir mΩ sınırı", "iç direnç", "empedans",
            "ripple", "satın almayı zorunlu kılmaz",
            "Son doğrulama: 29 Temmuz 2026",
        ],
        "links": [
        ...
        "source_hosts": ["fluke.com", "ieee.org", "megger.com", "vertiv.com"],
    },
    {
        "slug": "ev-sarj-ocpp-iso-15118-plug-charge-farki",
        "required": [
            "OCPP", "ISO 15118", "Plug & Charge", "CSMS",
            "birbirinin yerine geçmez", "exact model/firmware", "OCA",
            "Son doğrulama: 29 Temmuz 2026",
        ],
        "links": [
            "/haberler/ev-sarjinda-dinamik-yuk-yonetimi",
            "/haberler/v2l-v2h-v2g-farki-cift-yonlu-sarj",
        ...
        "source_hosts": ["openchargealliance.org", "iso.org"],
    },
]
...
def main() -> None:
    ...
    assert manifest["version"] >= 60, manifest["version"]
    ...
    outage = (REPO_ROOT / "alo186/haberler/elektrik-kesintisi-tazminati-yillik-uzun-sureli-nasil-odenir/index.html").read_text(encoding="utf-8").casefold()
    battery = (REPO_ROOT / "alo186/haberler/ups-aku-ic-direnc-impedans-kapasite-testi-farki/index.html").read_text(encoding="utf-8").casefold()
    ev = (REPO_ROOT / "alo186/haberler/ev-sarj-ocpp-iso-15118-plug-charge-farki/index.html").read_text(encoding="utf-8").casefold()
    assert "tek bir süreç değildir" in outage and "sabit bir tl hesabı yayımlamaz" in outage
    assert "gerçek ah kapasitesi" in battery and "tek bir yüksek empedans" in battery
    assert "protokolü veya sertifika" in ev and "sırf sürüm numarası" in ev
