...
ARTICLES = [
    {
        "slug": "ges-inverter-riso-dusuk-izolasyon-direnci-arizasi",
        "required": [
            "PV insulation resistance Riso",
            "ground fault isolation",
            "DC string segmentation",
        ...
        "links": [
            ...
            "/haberler/ges-mc4-konnektor-farkli-marka-birlikte-kullanilir-mi",
            "/hesaplama/teknik-devir-kabul-paketi/",
            "/hizmetler/ges-batarya-ev-sarj-fizibilitesi/",
        ],
        "source_hosts": ["manuals.sma.de", "support.huawei.com", "knowledge-center.solaredge.com", "manuals.fronius.com"],
    },
    {
        "slug": "ups-aku-sicaklik-kompanzasyonu-termal-kacak",
        "required": [
            "VRLA temperature compensation",
        ...
        "links": [
            "/haberler/ups-aku-ic-direnc-empedans-kapasite-testi-farki",
            "/hesaplama/yedek-guc-cozum-secici/",
            "/hesaplama/teknik-devir-kabul-paketi/",
            "/hizmetler/elektrik-surekliligi-izleme/",
        ],
        "source_hosts": ["vertiv.com", "eaton.com", "enersys.com"],
    },
    {
        "slug": "ev-sarj-kablosu-kesiti-gerilim-dusumu-isinma",
        "required": [
            "EV charging cable sizing",
            "voltage drop",
        ...
        "source_hosts": ["electrical.theiet.org", "productinfo.se.com", "se.com"],
    },
]
...
def main() -> None:
    ...
    assert manifest["version"] >= 45, manifest["version"]
    article_routes = [route for route in manifest["routes"] if route["type"] == "article"]
    assert len(article_routes) >= 102, len(article_routes)
