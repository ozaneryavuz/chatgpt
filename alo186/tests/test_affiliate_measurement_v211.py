...
MODULE_PATH = ROOT / 'alo186' / 'deployment' / 'inject_affiliate_measurement_v211.py'
spec = importlib.util.spec_from_file_location('affiliate_measurement_v211', MODULE_PATH)
...
def assertions(site: Path, base_path: str = '') -> None:
    ...
    expected_src = f'{base_path}/assets/affiliate-measurement-v211.js' if base_path else '/assets/affiliate-measurement-v211.js'
