...
const ROUTE = path.join(ROOT, 'amazon-elektrik-urunleri', 'modem-wifi-kapsama-olcum-menzil-genisletici-secimi');
...
assert.strictEqual(catalog.category.requiredTool, 'embedded-modem-wifi-range-measurement-v231');
...
const canonical = 'https://alo186.com/amazon-elektrik-urunleri/modem-wifi-kapsama-olcum-menzil-genisletici-secimi/';
...
assert.ok(HTML.includes('mevcut'));
assert.ok(HTML.includes('satın alma'));
...
console.log(JSON.stringify({
  ok: true,
  route: '/amazon-elektrik-urunleri/modem-wifi-kapsama-olcum-menzil-genisletici-secimi/',
