(function(root,factory){
  ...
  function companyUrl(company){
    return company?`https://www.alo186.com/dagitim-sirketleri/${company.slug}`:'https://www.alo186.com/elektrik-kesintisi';
  }

  function provinceUrl(provinceName){
    return `https://www.alo186.com/il/${provinceSlug(provinceName)}`;
  }
