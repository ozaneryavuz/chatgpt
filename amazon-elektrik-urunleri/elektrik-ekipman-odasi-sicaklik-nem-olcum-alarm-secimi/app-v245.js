(function () {
  "use strict";
  const catalog = window.ALO186EquipmentRoomClimateCatalogV245;
  if (!catalog) return;
  ...
  function update() {
    if (!readinessIds.every(checked)) {
      return lock("Önce ortam, kuru konum, ölçüm aralığı, kritik olmayan kullanım, mevcut sistem, hub ve ürün varyantı kontrollerini tamamlayın.");
    }
    ...
    status.textContent = opened
      ? "Kontroller tamamlandı. Amazon Türkiye sayfasında ASIN, MPN, sensör modeli ve hub uyumunu yeniden doğrulayın."
